<<<<<<< HEAD:src/app/pages/pokemon/pokemon-navbar/pokemon-navbar.ts
...
>>>>>>> 593f8b1 (feat(pokemon): enhance Pokemon info display with new attributes and shiny toggle):src/app/components/pokemon/pokemon-navbar/pokemon-navbar.ts
